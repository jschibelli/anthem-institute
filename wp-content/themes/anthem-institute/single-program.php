...
<div class="container container--narrow page-section">
  ...
  $homepageEvents = new WP_Query(array(
    ...
    'meta_query' => array (
      ...
      // 04/05/2022 - TAG: This takes events that are related to a program and displays on the program page//
      array(
        'key' => 'related_programs',
        'compare' => 'LIKE',
        'value' => '"' . get_the_ID() .'"'
  ...
  if ($homepageEvents->have_posts()) { echo '<hr class="section-break">';
